...
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;
 ...
 public class DriveSystem {
    ...
    public DriveSystem (SparkMax FLDrive, SparkMax BLDrive, SparkMax FRDrive, SparkMax BRDrive, SparkMax FLTurn, SparkMax BLTurn, SparkMax FRTurn, SparkMax BRTurn, ADXRS450_Gyro A, SwerveDriveKinematics B) {
      ...
      FLWheel = new wheel (frontLeftDrive, frontLeftturn, 1.4, 0, 4, 0.506);   //1,2
      FRWheel = new wheel (frontRightDrive, frontRightturn, 1.4, 0, 4, 0.822); //3,4
      BLWheel = new wheel ( backLeftDrive, backLeftturn, 1.4, 0, 4, 0.127);    //8,7
      BRWheel = new wheel ( backRightDrive, backRightturn, 1.4, 0, 4, 0.309);  //5,6
